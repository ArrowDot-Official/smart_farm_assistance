...
class MotorController extends StatefulWidget {
  ...
  const MotorController({Key key, this.model, this.smsModel}) : super(key: key);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FutureBuilder(
              future: widget.model.translate("motor"),
        ...
        child: StreamBuilder<SmsMessage>(
          ...
          builder: (context, data) {
            ...
            return FutureBuilder<List<SmsMessage>>(
                future: SmsQuery().querySms(address: motor.number, kinds: [SmsQueryKind.Sent, SmsQueryKind.Inbox]),
                builder: (context, snapshot) {
                  ...
                  if (received.contains("POWER ON") || received.contains("POWER ON")) {
                    switch (received) {
                      case "on":
                        motor.status = "on";
                        break;
                          ...
                          Container(
                            ...
                            child: Flex(
                              ...
                              children: <Widget>[
                                ...
                                Image.asset("images/icon-03.png"),
                                ...
                                FlatButton(
                                  onPressed: () async {
                                    ...
                                    _sendMessage(motor.status == "off" ? on : off , motor.number);
                                    setState(() {});
                                  },
                                  child: motor.status == "on" ? Image.asset(onImg) : Image.asset(offImg),
//                            child: StreamBuilder<SmsMessage>(
...
//                            ),
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    await commandDialog(context, motor);
                                  },
                                )
  ...
  Future commandDialog(BuildContext context, Device motor) async {
    await showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          actions: <Widget>[
            _terminateButtonDialog(context,motor),
            _sendButtonDialog(context, motor),
          ],
        )
    );
  }
  ...
  _sendButtonDialog(BuildContext context, Device motor) {
    return FlatButton(
      onPressed: () async {
        ...
        await _sendMessage(msg, motor.number);
